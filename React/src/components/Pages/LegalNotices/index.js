    ...
    <section className={classes.LegalNoticeWrapper}>
      <Container className={classes.container}>
        ...
        <Typography variant="body2" align="left" color="textSecondary" component="p" gutterBottom>
          ...
          pour la Confiance dans l’économie numérique, dite L.C.E.N., il est porté à la connaissance des Utilisateurs du site olocal.com
           les présentes mentions légales.
        </Typography>

        <Typography variant="body2" align="left" color="textSecondary" component="p" gutterBottom>
          La connexion et la navigation sur le site (oLocal) par l’Utilisateur implique acceptation intégrale et 
        ...
        <Typography variant="body2" align="left" color="textSecondary" component="p" gutterBottom>
          ...
          à 18, rue des imaginaires Paris 75021, adresse e-mail : olocal.mail@gmail.com.
        </Typography>
        ...
        <Typography variant="body2" align="left" color="textSecondary" component="p" gutterBottom>
          L'hébergeur du site olocal.com est la Société AWS, dont le siège social est situé à Seattle USA , 
          avec le numéro de téléphone : xx,xx,xx,xx,xx.
        </Typography>
        ...
        <Typography variant="body2" align="left" color="textSecondary" component="p" gutterBottom>
          ...
          des informations relatives à la navigation de celui-ci sur le site Internet. L’Utilisateur pourra 
        ...
        <Typography variant="body2" align="left" color="textSecondary" component="p" gutterBottom>
          ...
          du site olocal.com, sans autorisation de l’Éditeur est prohibée et pourra entraîner des actions 
